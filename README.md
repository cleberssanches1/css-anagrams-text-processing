...
## Processamento de letras API (css-anagrams-text-processing)
 
... Esta API tem como objetivo prover um sistema para para que sejam retornadas todas as possibilidades de posicionamento de letras.  
...
![Diagrama de Classes da API](src/main/resources/assets/TextProcessing_diagrama.png)
...
- Entre na raiz do projeto, pelo CMD é o seguinte comando: ```css-anagrams-text-processing```
...
- Com a aplicação lançada, abra o navegador web e acesse o LINK http://localhost:8090/swagger-ui/index.html.
...
## Links
 ...
 - Repository: https://github.com/cleberssanches1/css-anagrams-text-processing
